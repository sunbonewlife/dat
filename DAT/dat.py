...
# 版本号标识
version = "Version：0.1.1.20171212"
...
class MainFrame(wx.Frame):
    ...
    def make_menu_bar(self):
        ...
        self.Bind(wx.EVT_MENU, self.on_help_step, help_step_item)
...
if __name__ == '__main__':
    ...
    MainFrame(None, title="Data Analysis Tool  " + version).Show()
    app.MainLoop()